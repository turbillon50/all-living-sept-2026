...
export default function ResponsiblePage() {
  return <LegalShell><p className="legal-eyebrow">ESTAMOS PARA ESCUCHARTE</p><h1>Datos del responsable</h1><p className="legal-date">ALL LIVING Eventos · events.alliving.live</p>
    <h2>Razón social</h2><p>Colectivo Mass S.A. de C.V.</p><h2>Contacto</h2><p><a href="mailto:luisdelator@vmomentums.info">luisdelator@vmomentums.info</a></p><p>Este correo atiende consultas sobre el funcionamiento del sitio, privacidad, derechos sobre datos personales y reportes de contenido.</p>
